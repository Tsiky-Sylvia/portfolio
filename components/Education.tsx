...
const education = [
  ...
  },
  {
    ...
    school: "ITU",
    location: {
      fr: "Andoharanofotsy, Antananarivo, Madagascar",
      en: "Andoharanofotsy, Antananarivo, Madagascar",
    },
    year: "2022",
    description: {
        ...
        >
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2">
            <div className="flex items-start gap-3">
              {/* Icône */}
              <div
                className={`text-2xl bg-gradient-to-br ${edu.color} p-3 rounded-xl shrink-0`}
              >
                {edu.emoji}
              </div>
