  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      <motion.div
        ...
        className={`bg-gradient-to-br ${project.bg} rounded-2xl p-8 flex flex-col md:flex-row gap-8 items-start`}
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3 flex-wrap mt-2">
            ...
            <a href={project.demo}
              ...
              className={`px-6 py-2 bg-gradient-to-r ${project.color} text-white rounded-xl text-sm font-medium hover:opacity-90 transition-opacity`}
            >
              {t("view_demo")} →
            </a>
            ...
            <a href={project.github}
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-2 bg-white text-gray-700 border border-gray-200 rounded-xl text-sm font-medium hover:bg-gray-50 transition-colors"
            >
              GitHub
            </a>
          </div>
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          {project.challenges.map((challenge, index) => (
            ...
            >
              <span className={`text-lg bg-gradient-to-r ${project.color} bg-clip-text text-transparent font-bold shrink-0`}>
                {index + 1}.
              </span>
