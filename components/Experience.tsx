...
const experiences = [
  ...
  {
    title: {
      fr: "Web & Mobile Developer Intern",
      en: "Web & Mobile Developer Intern",
    },
    company: "Eqima Solutions",
    location: "Antananarivo, Madagascar",
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2">
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-2">
                <div
                  className={`w-3 h-3 rounded-full bg-gradient-to-r ${exp.color} shrink-0`}
                />
          ...
          <ul className="flex flex-col gap-2 ml-5">
            {exp.description[locale as "fr" | "en"].map((item, i) => (
              ...
              >
                <span className="text-violet-400 dark:text-violet-400 mt-0.5 shrink-0">
                  →
                </span>
