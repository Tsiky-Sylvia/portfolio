      ...
      <div className="max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center gap-16 py-20">
        ...
        <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
          ...
          >
            ...
            {locale === "fr" ? "Disponible pour des missions freelance" : "Available for freelance missions"}
          </motion.div>
          ...
          <div className="relative w-72 h-72 md:w-80 md:h-80">
            ...
            <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-white shadow-2xl">
              <Image
                ...
                onError={(e) => {
                  // Placeholder si la photo n'existe pas encore
              ...
              <div className="w-full h-full bg-gradient-to-br from-violet-100 to-purple-100 flex items-center justify-center">
                <svg
                  viewBox="0 0 200 200"
                  className="w-48 h-48 text-violet-300"
                  fill="currentColor"
                >
            ...
            {/* Badge localisation */}
            <div className="absolute -bottom-2 -right-2 bg-white rounded-xl shadow-lg px-3 py-2 flex items-center gap-2">
              <span>🇲🇬</span>
              <span className="text-xs font-medium text-gray-700">Antananarivo</span>
            </div>
          </div>
        </motion.div>
      </div>
